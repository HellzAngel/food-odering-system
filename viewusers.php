...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    ...
    <body>
        ...
        <section  >
           ...
           <tr bgcolor="#000000"><th width="50%"><p align="center">USER NAME</p></th><th  width="50%"><p align="center">CONTACT</p></th></tr>
           <?php
		      include('query.php');
    $ob=new query();
	 $res=$ob->showusers();
    ...
    echo "<td ><p align='center'>$r[1]</p></td></tr>";
		 }
		 
	 }
	 else
	 {
		 echo "<tr><th  colspan='2' ><p align='center'>NO USERS !</p></th></tr>";
		 }
