...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
  ...
  <tr align="center" bgcolor="#000000">
    <th scope="row"  align="center"><p align="center">CHOOSE RESTAURANT</p></th>
    </tr></table><br>
  
  <table width="50%" align="center" cellpadding="10" cellspacing="10">
  <tr align="center" bgcolor="#000000">
    <td ><p align="center">RESTAURANT</p></td><td><p align="center">CONTACT</p></td><td><p align="center">RATING</p></td></tr>
    <?php
 include('query.php');
    $ob=new query();
     $res=$ob->showrest();
         ...
         {
    echo "<tr style='background:white;color:black;border-bottom:1px solid black''><td align='center'><a href='buyitems.php?rid=$r[5]'>$r[1]</a></td><td align='center'><p>$r[3]</p></td><td align='center'><p>$r[4]</p></td></tr>";
}
?>
